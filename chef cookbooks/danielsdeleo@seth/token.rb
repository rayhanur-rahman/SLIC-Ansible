    ...
    class Security
      class Token
        ...
        def enable_privileges(*privilege_names)
          ...
          new_privileges = Seth::ReservedNames::Win32::API::Security::TOKEN_PRIVILEGES.new(
            FFI::MemoryPointer.new(Seth::ReservedNames::Win32::API::Security::TOKEN_PRIVILEGES.size_with_privileges(privilege_names.length)))
          new_privileges[:PrivilegeCount] = 0
          privilege_names.each do |privilege_name|
            luid = Seth::ReservedNames::Win32::API::Security::LUID.new
            ...
            if Seth::ReservedNames::Win32::API::Security.LookupPrivilegeValueW(nil, privilege_name.to_wstring, luid)
              ...
              new_privilege[:Attributes] = Seth::ReservedNames::Win32::API::Security::SE_PRIVILEGE_ENABLED
              new_privileges[:PrivilegeCount] = new_privileges[:PrivilegeCount] + 1
            end
          end

          old_privileges = Seth::ReservedNames::Win32::Security.adjust_token_privileges(self, new_privileges)
        end

        def adjust_privileges(privileges_struct)
          if privileges_struct[:PrivilegeCount] > 0
            Seth::ReservedNames::Win32::Security::adjust_token_privileges(self, privileges_struct)
          end
        end
      end
    end
