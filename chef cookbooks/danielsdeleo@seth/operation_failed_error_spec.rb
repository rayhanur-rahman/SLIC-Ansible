...
describe Seth::sethFS::FileSystem::OperationFailedError do
  context 'message' do
    ...
    context 'has a cause attribute and HTTP result code is 400' do
      it 'include error cause' do
        ...
        proc {
          raise Seth::sethFS::FileSystem::OperationFailedError.new(:write, self, exception), error_message
        }.should raise_error(Seth::sethFS::FileSystem::OperationFailedError, "#{error_message} cause: #{response_body}")
      end
    end
    ...
    context 'does not have a cause attribute' do
      it 'does not include error cause' do
        proc {
          raise Seth::sethFS::FileSystem::OperationFailedError.new(:write, self), error_message
        }.should raise_error(Seth::sethFS::FileSystem::OperationFailedError, error_message)
      end
    end
  end
end
