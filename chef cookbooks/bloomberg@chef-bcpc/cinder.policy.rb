...
default['bcpc']['cinder']['policy'] = {
  ...
  "volume:get_volume_admin_metadata" => "rule:admin_or_owner",
  "volume:delete_volume_admin_metadata" => "rule:admin_or_owner",
  "volume:update_volume_admin_metadata" => "rule:admin_or_owner",
