...
if defined?(Rack::MiniProfiler)
  ...
  Rack::MiniProfiler.config.storage_instance = Rack::MiniProfiler::MemcacheStore.new(Dalli::Client.new(ENV["MEMCACHIER_SERVERS"].try(:split, ","), {:username => ENV["MEMCACHIER_USERNAME"], :password => ENV["MEMCACHIER_PASSWORD"]}))
